...
const AppStore: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Apps */}
      <div
        className="appStore-apps flex flex-col justify-between items-start h-[85%] w-full bg-[#131314] my-5 py-3 px-3 overflow-hidden overflow-y-auto"
        style={{
          scrollbarWidth: "thin",
      ...
      {openApp && (
        <div
          className={`absolute w-full h-[92%] ${openApp ? "openApp" : "closeApp"
            } z-50`}
        >
          <AppDetails
            app={selectedApp}
